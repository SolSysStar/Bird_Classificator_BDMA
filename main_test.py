...
train_transforms = transforms.Compose([
    ...
    transforms.RandomRotation(30),  # Rotate image up to ±30 degrees
    transforms.ColorJitter(brightness=0.2, contrast=0.2, saturation=0.2, hue=0.1),  # Adjust colors
    transforms.RandomAffine(degrees=15, translate=(0.1, 0.1)),  # Small translation & rotation
...
# Load pre-trained DenseNet201 model (largest available DenseNet model)
model = models.densenet201(weights="IMAGENET1K_V1")  # or weights=DenseNet201_Weights.IMAGENET1K_V1 if available
